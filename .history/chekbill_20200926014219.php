...
VALUES(
   NULL,
    (SELECT SUM(product_price) as price FROM products,orders WHERE products.product_id = orders.product_id),
    (SELECT SUM(num) AS num FROM `orders`),
    CURRENT_TIMESTAMP()
...
<div class="receipt">
	...
	<section class="cart">
          ...
          ?>
				<li class="list__item">
					<span class="list__name"><?php echo $rows["product_name"];?></span>
					<span class="list__num"> </span>
					<span class="list__price">$<?php echo $rows["product_price"];?></span>
                </li>
            <?php } ?>
				<!-- <li class="list__item">
			...
			<footer class="cart__total">
				<h3 class="cart__total-label">Total</h3>
					<span class="list__num">2</span>
				<span class="cart__total-price"><?php echo "$".$_SESSION["total"]; ?></span>				
			</footer>
	</section>
