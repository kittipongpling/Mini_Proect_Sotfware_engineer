...
<body onload="startTime()">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">โอ ตามสั่ง</a>
                ...
                <div class="col-lg-4 order-1">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-success btn-lg btn-block" type="submit"> <a href="./chekbill.php"> สั่งออเดอร์</a></button>
